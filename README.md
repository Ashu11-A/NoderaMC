...
**2,244 tests, zero failures** (`scripts/java-test-report.sh`, 2026-07-30).
...
| `peer` | **unified peer API (issue #30)** — distribution/runtime/discovery/archival/control/diagnostics plus authenticated validation, disjoint-committee transfer routing, durable journals, mesh-population and boundary-independence lanes, and the NDR2 authorisation table enforced at dispatch (a peer may only speak for itself) | 652 | 🚧 |
