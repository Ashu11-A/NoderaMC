...
| `peer` | Peer runtime, discovery, distribution, archival, control, diagnostics, and the always-on `nodera-headless` node built from them | 847 | 🚧 |
...
| `tracker` | Tracker service binary — announce lifecycle, swarm registry, quotas | 108 | ✅ |
