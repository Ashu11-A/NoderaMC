...
| `storage-api` | `WorldStore` + content/event/checkpoint/certificate seam + `ContentId`/`Compression`/`Checkpoint`/`GenesisManifest` (tags 81–83, Task 9) + `WorldIdentity`/`WorldPermissionGrant`/`WorldPermissions` (tags 92/93, author-signed identity + P2P permission model, Task 33) | 22 | ✅ |
