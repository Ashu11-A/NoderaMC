...
**Tests:** `746 passing · 0 failing · 0 skipped` (+**144 Rust**) (adds **Task 32 peer worker + control
endpoint** (+2): new `nodera-headless` always-on worker (`HeadlessPeerMain` boots a `PeerRuntime` +
