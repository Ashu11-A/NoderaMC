...
public record NodeCapabilities(
        ...
        boolean acceptsWorker) implements Encodable {
    ...
    public static NodeCapabilities initial() {
        return new NodeCapabilities(4, 4L * 1024 * 1024 * 1024, 50, 0.95, 4, 8, true);
    }
     ...
     * maxValidatorRegions(u32) + acceptsWorker(u8)}.
     *
    ...
    public static NodeCapabilities decode(CanonicalReader r) {
        ...
        return new NodeCapabilities(cores, mem, latency, rel, maxPrimary, maxVal, accepts);
    }
}
