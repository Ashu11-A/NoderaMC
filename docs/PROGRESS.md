...
<!-- AI-AGENT-INSTRUCTION: This file is the DETAILED progress ledger (moved out of README.md,
     ...
     table + milestone notes here, recompute the README bar/percentage, and keep docs/Testing.md's
     counts in sync. Statuses must agree with README, docs/Testing.md, and docs/Roadmap.md. -->
