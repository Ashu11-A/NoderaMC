...
Snapshot: 2026-07-18 · overall `52%` · 576 tests green · MVP gate ([Task 7](Task.7.md)) proven
headlessly, not yet live · lane B: Tasks 19–24 landed headless; [Task 25](Task.25.md) next.
...
| Wave | Work | Why here |
|---|---|---|
| **0 — now, parallel** | (a) GUI-env acceptance passes for [1](Task.1.md)/[4](Task.4.md)/[18](Task.18.md) (`runServer`/`runClient`); (b) ~~[19](Task.19.md)→[24](Task.24.md) headless~~ **done** — lane B continues at [25](Task.25.md); (c) keep growing 17\* scenarios | (a) is small and blocks every live milestone; (b) the torrent cluster is Minecraft-free and does NOT wait on waves 1–3; (c) standing |
...
| **4 — network era** | [10](Task.10.md) libp2p/NAT + gateway migration; torrent chain ~~[20](Task.20.md)→[24](Task.24.md)~~ (headless) → [25](Task.25.md); [26](Task.26.md) last (needs 19–23) | 20 soft-depends on 10 only for NAT reach (LAN/VPN works without it); 25 also needs 7 |
...
Biggest schedule lever remains **wave 0(b)** — Tasks 19–24 are now proven Minecraft-free while
waves 1–3 remain live-wiring work; Task 25 continues that parallel lane.
...
- **Issue lookup.** Task number ≠ issue number. Find issues by exact `Task N — <title>`; Tasks
  19–23 are #24–#28. Task 24 has no issue number yet — never reuse the README's old `#24`
  placeholder.
