...
**Tests:** `1,412 passing · 0 failing · 0 skipped` (+**150 Rust workspace**, **56 `nodera-app`**;
**1,588 total**). Per module (authoritative `./gradlew check` XML): core 233 · engine 430 ·
transport 93 · storage 97 · testing 14 · peer 445 · neoforge-mod 83 (engine 430 → 447).
