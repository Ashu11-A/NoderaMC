...
| `library/java/core/.../consensuscert/VoteDecision.java` | 55 | 147.3 | BlockMutation, CommitteeChangeCertificate, PeerRole, … | Tag+version guard (single `u8` ordinal body) — `Encodable`-enum helper. |
