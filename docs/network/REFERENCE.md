...
* **`docs/tracker/REFERENCE.md`** — BitTorrent-style trackers: the swarm abstraction, the announce
...
* **`docs/rendezvous/REFERENCE.md`** — rendezvous and relay: namespaces, candidates, the three logical
...
### 9.1 `docs/tracker/REFERENCE.md` → NoderaMC
...
### 9.2 `docs/rendezvous/REFERENCE.md` → NoderaMC
...
24. **Spec citations are unverified by any test.** `docs/tracker/REFERENCE.md` and
