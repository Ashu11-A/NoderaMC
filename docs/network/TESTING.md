...
**Category:** network · **Last run:** 2026-07-26 · **721 Java tests + 35 Rust (`nodera-codec`) ·
...
| `peer` | Distribution, runtime, discovery, archival, diagnostics, headless worker, validation lane, durable coordinator state, the endpoint tenant boundary | 515 | 🚧 |
