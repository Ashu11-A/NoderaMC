...
**Category:** network · **Last run:** 2026-07-30 · **997 Java test cases + 73 Rust (`nodera-codec`)
`#[test]` · 0 failing at the last gate** — Java counts come from Gradle XML reports and sum the module
table below (187 + 157 + 653). Worker-module cases are accounted under the worker category.
