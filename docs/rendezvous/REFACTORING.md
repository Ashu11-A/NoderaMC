...
<!-- AI-AGENT-INSTRUCTION: A working register of refactoring debt in the rendezvous modules
     (rust/nodera-rendezvous/ + java/transport/.../dev/nodera/transport/rendezvous/). Source:
...
`rust/nodera-rendezvous/src/` and `java/transport/src/{main,test}/java/dev/nodera/transport/rendezvous/`.
