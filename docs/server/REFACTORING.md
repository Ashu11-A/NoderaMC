...
<!-- AI-AGENT-INSTRUCTION: This register tracks duplication and refactor debt in endpoints/paper-plugin.
...
(filtered to `endpoints/paper-plugin/`) + manual review · Open candidates: **0**
...
jscpd run over the whole Java tree reports **0 duplicated blocks** touching `endpoints/paper-plugin/`, and
