...
Whole-tree Java total for that same run: **2,292 tests · 0 failed · 0 skipped**. That figure is the
sum of the nine per-module counts README's module table carries — core 314, engine 446, transport
189, storage 168, testing 46, peer 861, endpoint 114, neoforge-mod 134, paper-plugin 20 — which is
