...
package gradle.kotlin.dsl.plugins._e0512b58db31bdabb475e2d32e11d6bc
...
/**
 * The `net.neoforged` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetNeoforgedPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.neoforged`.
 */
internal
val `NetPluginGroup`.`neoforged`: `NetNeoforgedPluginGroup`
    get() = `NetNeoforgedPluginGroup`(plugins)


/**
 * The `net.neoforged.moddev` plugin implemented by [net.neoforged.moddevgradle.boot.ModDevPlugin].
 */
internal
val `NetNeoforgedPluginGroup`.`moddev`: PluginDependencySpec
    get() = plugins.id("net.neoforged.moddev")
