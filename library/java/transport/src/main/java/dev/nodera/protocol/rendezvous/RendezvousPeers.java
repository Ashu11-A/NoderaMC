...
/**
 * A page of discovered peer records (Task 29, wire tag 37; docs/rendezvous/REFERENCE.md). Each record is
 * independently signed and must be verified end-to-end by the discovering peer — the rendezvous
 * point introduced the peers, it did not vouch for them (docs/rendezvous/REFERENCE.md).
 *
