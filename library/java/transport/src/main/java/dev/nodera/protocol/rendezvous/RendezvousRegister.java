...
/**
 * A peer's signed self-registration with a rendezvous point (Task 29, wire tag 35;
 * {@code docs/rendezvous/REFERENCE.md}). Carries one {@link SignedRecord}; the service verifies the signature before touching its
