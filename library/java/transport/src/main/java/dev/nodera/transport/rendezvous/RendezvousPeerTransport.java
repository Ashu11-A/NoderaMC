 ...
 *
 * <p><b>Composition (docs/rendezvous/REFERENCE.md).</b> A {@link TransportSelector} chooses per peer:
 ...
 * re-verifies the far end owns the {@code NodeId} of the discovered record. A discovered
...
public final class RendezvousPeerTransport implements PeerTransport {
    ...
    public void start() {
        ...
        try {
            ...
            // published (docs/rendezvous/REFERENCE.md).
    ...
    private void registerSelf() throws IOException {
        ...
        // Publishing to a subset is a working registration (docs/rendezvous/REFERENCE.md merges results);
     ...
     * reservation as fallback (docs/rendezvous/REFERENCE.md preference order).
     *
    ...
    /** Re-publish this peer's record before the registration lease expires (docs/rendezvous/REFERENCE.md). */
