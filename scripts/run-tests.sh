...
#   continuity ownership ownership-follow churn pickup mobs pearl password rekey commands farlands crash
#
...
ALL_SUITES=(continuity ownership ownership-follow churn pickup mobs pearl password rekey commands farlands crash)
