...
#   continuity ownership ownership-follow churn pickup password rekey commands farlands crash
#
...
ALL_SUITES=(continuity ownership ownership-follow churn pickup password rekey commands farlands crash)
