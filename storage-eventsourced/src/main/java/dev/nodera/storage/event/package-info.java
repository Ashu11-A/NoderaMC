 ...
 *
 * <p>Implements the {@code storage-api} seam: a content-addressed blob store, append-only per-region
 ...
 * uncommitted.
 *
 * <p>Everything is pure Java over {@code core} + {@code storage-api}; the archival RocksDB tier will
