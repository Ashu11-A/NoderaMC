...
//!
//! State is deliberately ephemeral (`docs/tracker/REFERENCE.md`, "Records, sampling and
//! expiry"). A tracker restart loses
...
pub struct PeerRecord {
    ...
    /// treated as proof of identity (`docs/tracker/REFERENCE.md`, "Records, sampling and expiry").
